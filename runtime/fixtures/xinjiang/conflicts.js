...
exports.xinjiangSourceConflicts = void 0;
...
exports.xinjiangSourceConflicts = rows.map(([code, title, reason], i) => ({ id: 'xinjiang-conflict-' + code, tripId: 'xinjiang-2026', code, title, status: 'conflict', sourceSections: ['新疆攻略14.4'], adoptedValue: reason, resolutionReason: reason, userConfirmed: false, createdAt: now, updatedAt: now, revision: i + 1 }));
