...
exports.createVisitorView = createVisitorView;
const budget_1 = require("../domain/calculations/budget");
function freeze(value) { if (value && typeof value === 'object') {
    Object.values(value).forEach(freeze);
    Object.freeze(value);
} return value; }
function createVisitorView(trip) {
    const budget = (0, budget_1.calculateBudget)(trip.budgetItems);
    return freeze({ schemaVersion: 1, tripId: trip.trip.id, title: trip.trip.title, startDate: trip.trip.startDate, endDate: trip.trip.endDate, participantCount: trip.participants.length,
